...
リポジトリが小さいほど、クローン作成が速く、操作やメンテナンスが簡単になります。
[リポジトリ サイズの制限](https://docs.github.com/ja/repositories/working-with-files/managing-large-files/about-large-files-on-github#repository-size-limits)

# Commit について

## 注意事項

**※`develop`や`main`ブランチへの直 Push は禁止しています。(できないようにしています。)**
...
```toml
# ==== コミットメッセージフォーマット(テンプレート) ====
<Emoji> #<Issue Number> <Title>
# 例) :sparkles: #1 ログイン機能を追加
#
# Commit body...
# 例) ログイン機能を追加しました。

# ==== Emojis ====
# ✏️  :pencil2: ドキュメンテーションの作成
# 🐛  :bug: バグ修正
# 👍  :+1: 機能改善
# ✨  :sparkles: 部分的な新機能開発
# 🎉  :tada: 大きな新規機能開発
# ♻️  :recycle: リファクタリング
# 🚿  :shower: 廃止された機能や特徴の削除
# 💚  :green_heart: テストやCIの修正・改善
# 👕  :shirt: Lintエラーの修正やコードスタイルの修正
# 🚀  :rocket: パフォーマンス改善
# 🆙  :up: 更新、例えば依存ライブラリの更新など
# 🔒  :lock: 新機能の範囲制限
# 👮  :cop: セキュリティ関連の改善
